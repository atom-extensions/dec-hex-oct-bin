            ...
            <div className="dec-hex-oct-bin">
                <div className="padded">
                    <div className="row block inset-panel">
                        <div className="col"><button className="btn" id="parse-decimal" title="Choose input type" on={{click: this.parseDecimal}}>Decimal</button></div>
                        <div className="col number highlight" id="decimal" title="Copy this value" on={{click: this.copy}}>{this.state.decimal}</div>
                    </div>
                    <div className="row block inset-panel">
                        <div className="col"><button className="btn" id="parse-hex" title="Choose input type" on={{click: this.parseHex}}>Hex</button></div>
                        <div className="col number highlight" id="hex" title="Copy this value" on={{click: this.copy}}>{this.state.hex}</div>
                    </div>
                    <div className="row block inset-panel">
                        <div className="col"><button className="btn" id="parse-octal" title="Choose input type" on={{click: this.parseOctal}}>Octal</button></div>
                        <div className="col number highlight" id="octal" title="Copy this value" on={{click: this.copy}}>{this.state.octal}</div>
                    </div>
                    <div className="row block inset-panel">
                        <div className="col"><button className="btn" id="parse-binary" title="Choose input type" on={{click: this.parseBinary}}>Binary</button></div>
